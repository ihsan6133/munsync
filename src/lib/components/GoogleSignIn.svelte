...
<button type="button" onclick={signUpGoogle} class="text-sm bg-zinc-900 border border-zinc-700 w-full p-2.5 rounded-md flex items-center justify-center gap-2 hover:bg-zinc-800 duration-200 cursor-pointer">
