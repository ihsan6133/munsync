<div class="flex items-center justify-center h-screen">
    <form action="" class="w-73 flex flex-col gap-4  items-center">
        <h1 class="text-xl text-sky-400 font-semibold"><a href="/">Munsync</a></h1>
        <button class="text-sm bg-zinc-900 border border-zinc-700 w-full p-2.5 rounded-md flex items-center justify-center gap-2 hover:bg-zinc-800 duration-200 cursor-pointer">
